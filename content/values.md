...
Status: published
og_image: images/values/myframework.jpg
...
![The "I don't want to play with you any more" meme, with Google and "Don't be evil"][google]
...
![I don't know the name of this meme, but it's the one with the guy about to smash a card onto the table in a card game. He's labeled "Yo" (me), the table is "Una conversacion casual" (a casual conversation), and his card is "El problema es el capitalismo" (the problem is capitalism)][elproblema]
...
![Photo of Tim Apple presenting that engraved glass disc with the golden base to Donald Trump. The disc is foregrounded, with the two men out of focus in the background.][timapple]

No doubt there are many regulations that could be put in place to increase repairability of all sorts of devices and reduce other sources of e-waste. Stuff along the lines of the EU's regulations on [phone repairability][phonerepair], and the [common charger rules][common] that came into force for most devices in December 2024, and will apply to laptops from April 2026. We should be dictating to the industry the [standards of repairability][repair] and sustainability that they have to meet, not hoping for plucky American startups to innovate a new set of norms - and we should be ruthless in our demands.
...
![Pixel art portrait of James Connolly][jimmy]

[myframework]: {static}/images/values/myframework.jpg "My Framework 13. Repairable. Not a MacBook."
[google]: {static}/images/values/google.jpg "The most famous and blatant example"
[forum]: https://community.frame.work/t/framework-supporting-far-right-racists/75986 "Community forum thread about Framework sponsorship issues."
[elproblema]: {static}/images/values/el-problema.jpg "I just can't help myself."
[common]: https://commission.europa.eu/news-and-media/news/eu-common-charger-rules-power-all-your-devices-single-charger-2024-12-28_en "European Commission article about the common charger rules."
[phonerepair]: https://eur-lex.europa.eu/eli/reg/2023/1670/oj "EU regulation on phone repairability."
[repair]: https://repair.eu/whats-my-right-to-repair/ "Right to Repair EU's chart of right to repair legislation by device type."
[jimmy]: {static}/images/values/jimmy.png "To adapt a phrase..."
[timapple]: {static}/images/values/timapple.jpg "Orange man bad. Apple man also bad."
